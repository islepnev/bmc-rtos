...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(ON_TDC_A_GPIO_Port, ON_TDC_A_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(ON_TDC_B_GPIO_Port, ON_TDC_B_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(ON_TDC_C_GPIO_Port, ON_TDC_C_Pin, GPIO_PIN_RESET);
