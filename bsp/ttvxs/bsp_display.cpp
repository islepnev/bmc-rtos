...
void pm_pgood_print(const pm_pgoods pgood)
{
    ...
    printf("Power good: 3.3V %3s,  2.5V %3s, 1.0V core %3s,  1.0 mgt %3s,  1.2 mgt %3s,  3.3 fmc %3s",
           pgood.pgood_3v3      ? STR_ON : STR_OFF,
           pgood.pgood_2v5      ? STR_ON : STR_OFF,
           pgood.pgood_1v0_core ? STR_ON : STR_OFF,
           pgood.pgood_1v0_mgt  ? STR_ON : STR_OFF,
           pgood.pgood_1v2_mgt  ? STR_ON : STR_OFF,
           pgood.pgood_3v3_fmc  ? STR_ON : STR_OFF
           );
    printf("%s\n", ANSI_CLEAR_EOL);
}
