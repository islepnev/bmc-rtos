...
add_library(CMSIS_${STM32_CHIP} OBJECT ${CMSIS_SOURCES})
TARGET_INCLUDE_DIRECTORIES(CMSIS_${STM32_CHIP} PUBLIC
    ${CMSIS_INCLUDE_DIRS}
)
STM32_SET_TARGET_PROPERTIES(CMSIS_${STM32_CHIP})

#message("${STM32_CHIP} STM32_FAMILY_LOWER=${STM32_FAMILY_LOWER}")
message("${STM32_CHIP} CMSIS_DEVICE_HEADERS=${CMSIS_DEVICE_HEADERS}")
message("${STM32_CHIP} CMSIS_DEVICE_INCLUDE_DIR=${CMSIS_DEVICE_INCLUDE_DIR}")
#message("${STM32_CHIP} CMSIS_COMMON_INCLUDE_DIR=${CMSIS_COMMON_INCLUDE_DIR}")
#message("${STM32_CHIP} CMSIS_INCLUDE_DIRS=${CMSIS_INCLUDE_DIRS}")
#message("${STM32_CHIP} CMSIS_SOURCES=${CMSIS_SOURCES}")
