...
{
    switch(index) {
    case SENSOR_TDCA_2V5: return sw[PSW_5V];
    case SENSOR_TDCB_2V5: return sw[PSW_5V];
    case SENSOR_VME_5V: return 1;
    case SENSOR_INT_3V3: return sw[PSW_5V];
    ...
    case SENSOR_CLOCK_3V3: return sw[PSW_5V] && sw[PSW_CLOCK_3V3];
    case SENSOR_CLOCK_2V5: return sw[PSW_5V] && sw[PSW_CLOCK_2V5];
...
void read_power_switches_state(pm_switches sw_state)
{
    ...
    sw_state[PSW_INT_3V3]   = read_gpio_pin(ON_3V3_GPIO_Port,       ON_3V3_Pin);
    ...
    sw_state[PSW_TDCA_2V5]  = read_gpio_pin(ON_TDC0_2V5_GPIO_Port,  ON_TDC0_2V5_Pin);
    sw_state[PSW_TDCB_2V5]  = read_gpio_pin(ON_TDC1_2V5_GPIO_Port,  ON_TDC1_2V5_Pin);
}
...
void write_power_switches(pm_switches sw)
{
    ...
    write_gpio_pin(ON_3V3_GPIO_Port,       ON_3V3_Pin,       sw[PSW_INT_3V3]);
    ...
    write_gpio_pin(ON_TDC0_2V5_GPIO_Port,  ON_TDC0_2V5_Pin,  sw[PSW_TDCA_2V5]);
    write_gpio_pin(ON_TDC1_2V5_GPIO_Port,  ON_TDC1_2V5_Pin,  sw[PSW_TDCB_2V5]);
}
...
static int read_pgood_int_3v3(void)
{
    return read_gpio_pin(PGOOD_INT_3V3_GPIO_Port, PGOOD_INT_3V3_Pin);
}
...
void pm_read_pgood(pm_pgoods pgood)
{
    ...
    pgood[PGOOD_INT_3V3]   = read_pgood_int_3v3();
