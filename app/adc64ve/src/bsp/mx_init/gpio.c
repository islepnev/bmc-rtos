...
void MX_GPIO_Init(void)
{
  ...
  static const pin_def_t pgood_pins[] = {
      ...
      {PGOOD_1V8_GPIO_Port, PGOOD_1V8_Pin},
      {PGOOD_2V5_GPIO_Port, PGOOD_2V5_Pin},
      {PGOOD_2V5_CLK_GPIO_Port, PGOOD_2V5_CLK_Pin},
      {PGOOD_3V3_GPIO_Port, PGOOD_3V3_Pin},
      {PGOOD_3V3_CLK_GPIO_Port, PGOOD_3V3_CLK_Pin},
      {PGOOD_N1V2_GPIO_Port, PGOOD_N1V2_Pin},
  ...
  GPIO_InitStruct.Pin = CLK_IO_EXP_RESET_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_WritePin(CLK_IO_EXP_RESET_B_GPIO_Port, CLK_IO_EXP_RESET_B_Pin, GPIO_PIN_SET);
  HAL_GPIO_Init(CLK_IO_EXP_RESET_B_GPIO_Port, &GPIO_InitStruct);
