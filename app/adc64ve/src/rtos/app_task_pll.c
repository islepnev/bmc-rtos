...
#include "cmsis_os.h"
#include "adc64ve_clkmux/dev_adc64ve_clkmux_fsm.h"
#include "adc64ve_clkmux/dev_adc64ve_clkmux_types.h"
...
static Dev_adc64ve_clkmux clkmux = {0};
...
static void run(void)
{
    ...
    dev_adc64ve_clkmux_run(&clkmux);
    const bool power_on = enable_power && system_power_present;
    dev_ad9545_run(&pll, power_on);
    main_clock_ready = adc64ve_clkmux_running(&clkmux) && ad9545_running(&pll);
}
