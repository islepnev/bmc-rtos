...
static bool monIsOptional(SensorIndex index)
{
    ...
    case SENSOR_TDC_2V5:       return 1;
    case SENSOR_VME_12V:       return 0;
...
static double monShuntVal(SensorIndex index)
{
    ...
    case SENSOR_ADC_N2V5:      return 0.002;
    case SENSOR_ADC_P2V5:      return 0.002;
    case SENSOR_CLOCK_2V5:     return 0.002;
    case SENSOR_CLOCK_3V3:     return 0.002;
    case SENSOR_FPGA_1V8:      return 0.002;
    case SENSOR_FPGA_3V3:      return -0.002; // pins swap on PCB
    ...
    case SENSOR_TDC_2V5:       return 0.002;
    case SENSOR_VME_12V:       return 0.020;
...
static double monVoltageMarginWarn(SensorIndex index)
{
    ...
    case SENSOR_TDC_2V5:       return 0.10;
    case SENSOR_VME_12V:       return 0.1;
...
static double monVoltageMarginCrit(SensorIndex index)
{
    ...
    case SENSOR_TDC_2V5:       return 0.15;
    case SENSOR_VME_12V:       return 0.15;
...
static double monVoltageNom(SensorIndex index)
{
    ...
    case SENSOR_TDC_2V5:       return 2.5;
    case SENSOR_VME_12V:       return 12.0;
...
static int sensorBusAddress(SensorIndex index)
{
    ...
    case SENSOR_TDC_2V5:       return 0x4B;
    case SENSOR_VME_12V:       return 0x44;
...
static const char *monLabel(SensorIndex index)
{
    ...
    case SENSOR_TDC_2V5:       return "TDC 2.5";
    case SENSOR_VME_12V:       return "VME +12";
    case SENSOR_VME_3V3:       return "VME 3.3";
