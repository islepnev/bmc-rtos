...
{
    printf("Switch 5V main %s   3.3V %s   1.5V %s   1.0V core %s   1.0V mgt %s   1.2V mgt %s   5V FMC %s",
...
//    printf("%s\n", ANSI_CLEAR_EOL);
    printf("Power good: 3.3V %3s,  1.5V %3s, 1.0V core %3s,  1.0 mgt %3s,  1.2 mgt %3s,  3.3 fmc %3s",
           pm->pgood_3v3      ? STR_ON : STR_OFF,
           pm->pgood_1v5      ? STR_ON : STR_OFF,
